...
/////////////////
const BotName = 'Alpin BOT'; 
const instagram = 'https://instagram.com/kagakadaig'; 
const telegram = 'https://t.me/Alpin Jjj'; 
const kapanbotaktif = '9.00 sampai 23.00'; 
const youtube = 'https://www.youtube.com/c/AlpinOFC';
//const grupch1 = 'kosong'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@alpin.id')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => ('bot by ig:@alpin`)
})
...
if (text.includes("!sholat perbaikan")sedang rusak){
  const teks = text.replace(/!sholat perbaikan /, "")
