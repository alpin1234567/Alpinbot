...
/////////////////
const BotName = 'Alpinbot☄'; 
const instagram = 'kagak main:v'; 
const wa = '089690719275''; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Alpin OFC'';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@alpin')
