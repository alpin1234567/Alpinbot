...
const youtube = 'https://www.youtube.com/channel/UCPfM-qelpkAnDwBPF00k_XQ';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Alpin')
